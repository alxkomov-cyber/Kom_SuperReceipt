...
5. КРИТИЧЕСКИ ВАЖНО: Выведи ТОЛЬКО готовый текст. КАТЕГОРИЧЕСКИ ЗАПРЕЩАЕТСЯ выводить теги <think>, свои рассуждения, комментарии или вводные фразы. Сразу пиши финальный результат.
"""
...
def handle_voice(message):
    ...
    try:
        ...
        response = groq_client.chat.completions.create(
            model="qwen/qwen3.8-27b", # ваша текущая модель
            messages=[
